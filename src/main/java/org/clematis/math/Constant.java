...
import org.clematis.math.functions.Decimal;
...
import org.clematis.math.parsers.string.StringMathParserConstants;
...
public class Constant extends AbstractConstant {
    ...
    public String getValue(OutputFormatSettings fs) {
        ...
        if (fs != null) {
             ...
             */
            if (fs.isGrouping()) {
                str = NumberFormatter.groupThousands(str);
            } else {
                str = NumberFormatter.ungroupThousands(str);
            }
        } else {
            BigDecimal bd = new BigDecimal(NumberFormatter.ungroupThousands(str));
            str = bd.toString();
        }
