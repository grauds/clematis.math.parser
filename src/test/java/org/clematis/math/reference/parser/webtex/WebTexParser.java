...
public class WebTexParser/*@bgen(jjtree)*/implements WebTexParserTreeConstants, WebTexParserConstants {/*@bgen(jjtree)*/
  protected JJTWebTexParserState jjtree = new JJTWebTexParserState();public static void main(String args[]) {
 ...
 /*@bgen(jjtree) #EQUALS_EXPR(> 1) */
    ...
    jjtree.openNodeScope(jjtn000);String image=null;
    Token t;
    try {
      PlusExpression();
      label_1:
...
//Unary function
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x80000,0x20000,0x40000,0xf540e880,0xf540e880,0x10000,0x10000,0xf5446880,0x100000,0x200000,0xf5406880,0x6000,0xf0000000,};
   }
