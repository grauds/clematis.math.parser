...
public class Power extends aOperation
{
     ...
     */
     ...
     public iExpressionItem calculate() throws AlgorithmException
     {
        ...
        if ( exponent == null || ! AlgorithmUtils.isGoodNumericArgument( exponent ) )
        {
            return this;
        }
     ...
     */
     public iExpressionItem add(iExpressionItem item)
     {
         ...
         * Case: y^2 + y^2.
         */
         if ( this.aKindOf(item) && ( item instanceof Power ) )
         {
             /**
     ...
     public iExpressionItem multiply(iExpressionItem item) throws AlgorithmException
    {
         ...
         * Case: y * y^3.
         */
         else if ( this.aKindOf(item) && ( item instanceof Variable ) )
         {
    ...
    {
         if ( getOperand2() instanceof Constant )
         {
              Constant c = ( Constant ) getOperand2();
