// $Id: cot.java,v 1.1 2009-04-27 07:11:10 anton Exp $
...
public class cot extends aFunction
{
    ...
    public iExpressionItem calculate() throws AlgorithmException
    {
        ...
        {
           if( arguments.size() != 1 )
                throw new AlgorithmException("Invalid number of arguments in function 'cot': " + arguments.size() );
            ...
            return new Constant ( XMath.ctn(c1.getNumber()) * getMultiplier() );
        }
