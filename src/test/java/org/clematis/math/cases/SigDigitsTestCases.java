...
import org.clematis.math.functions.Lsu;
import org.clematis.math.functions.Sig;
...
public class SigDigitsTestCases extends AlgorithmTestCases
{
    ...
    public void testConstant() throws AlgorithmException
    {
       ...
       c.setMultiplier( 1 );
       c.setSdEnable( false );
       if ( !c.getValue().equals("-3.14154879879E45") && !c.getValue().equals("-3.14154879879E+45") )
       {
           throw new AlgorithmException( "Constant failed:" + c.getValue() + " instead of -3.14154879879E45", 0);
       }
       c.setSdEnable( true );
       if ( !c.getValue().equals("-3.1415488E45") && !c.getValue().equals("-3.1415488E+45") )
       {
           throw new AlgorithmException( "Constant failed:" + c.getValue() + " instead of -3.1415488E45", 1);
       }
       ...
       if ( !p.getOutputValue(true).equals("-3.14154879879E45") && !p.getOutputValue(true).equals("-3.14154879879E+45") )
       {
           throw new AlgorithmException( "Constant failed:" + p.getOutputValue(true) + " instead of -3.14154879879E45", 2);
       }
       ...
       {
           throw new AlgorithmException( "Constant failed:" + p.getOutputValue(true) + " instead of -3.1415488E45", 3);
       }
       p.setSdApplicable( false );
       if ( !p.getOutputValue(true).equals("-3.14154879879E45") && !p.getOutputValue(true).equals("-3.14154879879E+45") )
       {
           throw new AlgorithmException( "Constant failed:" + p.getOutputValue(true) + " instead of -3.14154879879E45", 4);
       }
       p.setSdApplicable( true );
       if ( !p.getOutputValue(true).equals("-3.1415488E45") && !p.getOutputValue(true).equals("-3.1415488E+45") )
       {
           throw new AlgorithmException( "Constant failed:" + p.getOutputValue(true) + " instead of -3.1415488E45", 5);
       }
    ...
    {
        System.out.println(Sig.getSigDigits( "0", 3));
        System.out.println(Lsu.getLSU( "0", 3));
        for ( int i = 1; i < 18; i++ )
        {
            System.out.println("Number of significant digits is: " + i);
            System.out.println("FIRST: " + Sig.getSigDigits( "38763475.809430000", i));
            System.out.println("SECOND: " + Sig.getSigDigits( "0.809430000", i));
            System.out.println("THIRD: " + Sig.getSigDigits( "387630000", i));
        }
        System.out.println("*: " + Sig.getSigDigits( "10.0001", 3));
        System.out.println(Sig.getSigDigits(Sig.getSigDigits("0.9999999999", 2), 2) );
        System.out.println(Sig.getSigDigits(Sig.getSigDigits("9000000", 2), 2) );
        System.out.println(Sig.getSigDigits(Sig.getSigDigits("9.9999999999", 2), 2) );
        System.out.println(Sig.getSigDigits(Sig.getSigDigits("9.99000", 2), 2) );
    }
    ...
    private static String[] tests = new String[]
    {
        ...
        "$Eth=sig(2, $Etht);" +
        /**
         * Next line causes exception: remove abs to reproduce
         * org.clematis.math.algorithm.AlgorithmException:
         * Exception in $vb=sig(2, sqrt(19.6*$d2t*sin($ang)-(2*$Etht/$m))):
         * Square root of negative base: -1.2351531965911 in line 12
         */
